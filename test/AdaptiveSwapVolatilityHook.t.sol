...
// mocks
import {VolatilityDataOracleMock} from "./mocks/VolatilityDataOracleMock.m.sol";

// contract to test
import {AdaptiveSwapHook} from "../src/AdaptiveSwapHook.sol";

contract TestAdaptiveSwapHook is Test, Deployers {
    using PoolIdLibrary for PoolKey;
    using StateLibrary for IPoolManager;

    AdaptiveSwapHook hook;
    VolatilityDataOracleMock volatilityOracle;
    ...
    function setUp() public {
        ...
        volatilityOracle = new VolatilityDataOracleMock();
    ...
    function test_overrideFeeBasedOnVolatility() public {
        ...
        assertEq(volatilityOracle.getLatestVolatilityData(), 100);
        ...
        assertEq(volatilityOracle.getLatestVolatilityData(), 130);
        ...
        assertEq(volatilityOracle.getLatestVolatilityData(), 70);
